...
※詳しい使い方は「 公式ドキュメント(日本語訳)」の[「beginStroke」](http://createjs.com/docs/easeljs/classes/Graphics.html#method_beginStroke)」と[「setStrokeStyle」](http://createjs.com/docs/easeljs/classes/Graphics.html#method_setStrokeStyle)」を確認ください。
